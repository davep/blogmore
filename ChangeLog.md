...
- Added `clean_urls` configuration file option (off by default). When set to
  ...
  instead. This applies to every reference generated by BlogMore: post links,
  RSS/Atom feeds, sitemap entries and canonical `<link>` tags. Combine it with
  a `post_path` such as `posts/{slug}/index.html` to give every post a clean,
  shareable URL like `https://example.com/posts/my-first-post/`.
  ([#262](https://github.com/davep/blogmore/pull/262))

...
!!! warning
    ...
    BlogMore is an experiment in using GitHub Copilot and Google Gemini CLI to develop a whole project from start to finish. As such, almost every part of this documentation was generated by Copilot or Gemini and what they know about the project. Please keep this in mind.
...
- **Automatic image optimization** - Optional multi-size "ladder" generation and next-gen WebP conversion for local images in Markdown posts; simple `<img>` tags are replaced with stable, responsive `<picture>` elements
